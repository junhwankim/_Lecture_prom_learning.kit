...
curl http://192.168.57.84:9113/metrics

# check below promql on prometheus web ui(https://192.168.57.11/graph).
nginx_up
...
```
# check again promql on prometheus web ui(https://192.168.57.11/graph).
nginx_up
