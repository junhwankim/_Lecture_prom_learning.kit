...
curl http://192.168.57.10:2381/metrics # etcd
curl http://192.168.57.10:10249/metrics # kube-proxy

# 3.check targets which is registered properly on targets menu (http://192.168.57.10/targets)
# kubelet
